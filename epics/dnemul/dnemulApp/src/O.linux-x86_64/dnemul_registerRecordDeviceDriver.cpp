...
/* Generated from ../O.Common/dnemul.dbd */
...
int dnemul_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/kkpr/Apps/EPICS/dnemul";
...
/* dnemul_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"dnemul_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(dnemul_registerRecordDeviceDriver(*iocshPpdbbase));
}
